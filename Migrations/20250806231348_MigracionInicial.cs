        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vacaciones_Personas_PersonaId",
                        column: x => x.PersonaId,
                        principalTable: "Personas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Restricciones_AspNetUsers_UsuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SolicitudesVacaciones_AspNetUsers_AprobadorId",
                        column: x => x.AprobadorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SolicitudesVacaciones_AspNetUsers_SolicitanteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Restricciones_UsuarioId",
                table: "Restricciones",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_SolicitudesVacaciones_AprobadorId",
                table: "SolicitudesVacaciones",
                column: "AprobadorId");

            migrationBuilder.CreateIndex(
                name: "IX_SolicitudesVacaciones_SolicitanteId",
                table: "SolicitudesVacaciones",
